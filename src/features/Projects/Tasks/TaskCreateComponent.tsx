  ...
  return (
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          <Button sx={{ marginTop:2 }} variant="contained" color="error" onClick={backToList}>Wróć do listy</Button>
          <Box
            component="form"
            sx={
              {
          ...
          >
            ...
            <TextField
              ...
              autoFocus
            />
            <Button variant="contained" color="success" onClick={createTask}> Utwórz zadanie</Button>
          </Box>
        </Box>
      </Container>
    </ThemeProvider>
